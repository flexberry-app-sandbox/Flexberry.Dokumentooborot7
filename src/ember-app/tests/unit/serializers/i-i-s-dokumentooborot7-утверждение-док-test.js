...
moduleForModel('i-i-s-dokumentooborot7-утверждение-док', 'Unit | Serializer | i-i-s-dokumentooborot7-утверждение-док', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dokumentooborot7-утверждение-док',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

...
namespace IIS.Dokumentooborot7
{
    ...
    public class ТЧПрава : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Dokumentooborot7.ПраваПол fПраваПол;
        ...
        public virtual IIS.Dokumentooborot7.ПраваПол ПраваПол
        {
            get
            {
                ...
                IIS.Dokumentooborot7.ПраваПол result = this.fПраваПол;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Dokumentooborot7.АвПользователи.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧПраваE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧПраваE", typeof(IIS.Dokumentooborot7.ТЧПрава));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧПрава : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Dokumentooborot7.DetailArrayOfТЧПрава members)

        // *** End programmer edit section *** (IIS.Dokumentooborot7.DetailArrayOfТЧПрава members)
        ...
        /// </summary>
        public DetailArrayOfТЧПрава(IIS.Dokumentooborot7.АвПользователи fАвПользователи) : 
                base(typeof(ТЧПрава), ((ICSSoft.STORMNET.DataObject)(fАвПользователи)))
        {
        }
        
        public IIS.Dokumentooborot7.ТЧПрава this[int index]
        {
            get
            {
                return ((IIS.Dokumentooborot7.ТЧПрава)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Dokumentooborot7.ТЧПрава dataobject)
        {
